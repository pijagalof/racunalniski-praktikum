...
\begin{enumerate}
    ...
    \item Pravilni odgovori so: $\cos x$, $\mathrm{cos}\,x$, $\operatorname{cos} x$  % tu napišite vse pravilne odgovore
    
    \item Pravilni odgovori so: $(\emptyset)$  % tu napišite vse pravilne odgovore
    
    \item Taylorjev razvoj funkcije $\sin x$ do tretjega člena: \[\sin x = x - \frac{x^3}{3!} + \mathcal{O}(x^5)\]

    \item Pravilni odgovori so:  (a) in (c) % tu naštejte vse pravilne odgovore
    % (a)
      \[ e^{i \pi} + 1 = 0 \]
    % (b)
      \begin{center}
    ...
    \item Pravilni odgovori so: (a) in (c) % tu naštejte vse pravilne odgovore
      ...
      \item Pravilni odgovori so: (b) v angleškem jeziku, (a) v finskem/švedskem, (d) v slovenskem. % tu naštejte vse pravilne odgovore
        \begin{enumerate}
        % (a)
          \item "Primer 1"
        % (b)
